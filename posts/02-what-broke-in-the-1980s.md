---
title: The collapse of the fertility rate in rural America in the 1980s
subtitle: Rural fertility fell 11.6% in five years while metro America did not move at all. The collapse tracks commodity exposure, mining counties fell harder than farming ones, and the setup has echoes today.
slug: what-broke-rural-america-1980s
date: 2026-09-03
description: The 1980s rural fertility collapse tracks commodity exposure: mining counties fell 21.9%, farming 14.8%, the rest of rural America far less. And the setup rhymes with the present.
hero: images/02-hero-commodity-bust-1680x1080.png
hero_alt: Line chart of the fertility rate from 1982 to 2024 for mining counties, farming counties, all other non-metro counties and metro counties. Mining and farming start together far above the rest, fall together through the 1980s bust, then separate: mining converges onto the other non-metro counties while farming holds a premium.
keywords: 1980s farm crisis fertility, rural fertility collapse, oil bust birth rate, commodity counties fertility, farm crisis history rhymes
...
Yesterday we split the fertility rate into metro and non-metro. One thing that surfaced was the steep drop in non-metro fertility in the 1980s and 1990s. We showed you the "what" yesterday. Today we explore the factors that, together, help us circle the "why." Then we hold that unique time in American history up against today, another unique time. The goal is to see what might prepare us for what comes next.

![Non-metro fertility rate, 1982 to 2024. The shaded span from 1982 to 1996 is the collapse this post is about: a fall of 17%, from 74.2 to 61.4, before a recovery through 2009 and a second decline since.](images/02-rural-collapse.png)
...
Crop prices fell, and land values fell with them. Midwestern farmland dropped 40 to 60% from its 1981 peak. That is what turned a downturn into a catastrophe. A farmer who had borrowed $800,000 against land now worth $400,000 was broke, however well he farmed. Good operators went under alongside bad ones.
...
![Fall in the fertility rate, 1982-87. All non-metro counties fell 11.6%. Broken out by type, mining fell 21.9%, farming 14.8%, persistent-poverty counties 12.3%, government 9.1%, manufacturing 8.6% and retirement destinations 8.3%. Metro counties, shown apart for comparison, fell 0.2%.](images/02-fall-by-county-type.png)
...
![Fertility rate, 1982 to 2024, for mining counties, farming counties, all other non-metro counties, and metro counties. Mining and farming start together far above the rest. Mining converges down onto the other non-metro counties by 2024; farming never does.](images/02-sector-trajectories.png)
...
![Change in the fertility rate by USDA rural-urban continuum class, for 1982-1994 and 1994-2024. In the first era the fall steepens with rurality; in the second it steepens with urbanity.](images/02-gradient-by-era.png)
...
**Boom leads to bust.** The 1970s farm boom was real — prices, exports and land values all tripled — and it made the 1980s possible. Farmers borrowed against inflated land because it was the obvious move, until the land was worth half as much and the loan was not. Farmland values are [up about 150% since 2010](https://www.ers.usda.gov/topics/farm-economy/land-use-land-value-tenure/farmland-value) and sit near record highs. Farm real estate makes up 83% of the sector's assets. The collateral and the asset are the same thing. That sentence was true in 1981 too. History keeps teaching this lesson, and we keep having to relearn it.
...
The honest version of the parallel: the cause is different. The 1980s squeezed farmers on the income side, through collapsing prices and exploding loan payments. Today squeezes them on the cost side. What they share is the result. Running a farm is getting harder, on several fronts at once, for reasons the farmer did not cause and cannot control.

**The rate shock, and where 1976 was.** While we do not have a Volcker, what we do have is a setup for inflation. We have written before about what is happening to diesel, and how it ripples through everything that moves by truck. We have also written about the labor-force trends that push the same way. A built-in inflation problem, if that is what this is, eventually forces rates up to meet it. The only thing that derails that, in our view, is an outright slowdown that destroys enough demand to pull prices back down.

Here the late 1970s are worth a close look, because the interesting question is not how high rates went but where they started. [Inflation bottomed at 5% in December 1976](https://www.federalreservehistory.org/essays/anti-inflation-measures). By the time Volcker took office in August 1979 it was running at 9%, and short rates were already near 11% before he had done anything. It took three years, an oil shock, and a Fed that had already doubled rates to get to the point where Volcker's 20% was the only move left. That oil shock came from Iran, then too — another uncanny parallel worth chewing on.

Today's measured inflation is 3.4%. As we have written, actual inflation is likely higher than that. The fed funds rate is 3.5 to 3.75%, and the [30-year Treasury touched 5.31% in August](https://www.cnbc.com/2026/08/17/treasury-yields-federal-reserve-fomc-minutes.html), its highest since 2007. That is roughly where the 1970s stood in 1976 or 1977, with an Iranian oil shock underway. The rhyme is not in the level. It is in the starting point, and in what came next last time.

**Expectations.** Core inflation, which strips out food and energy, is 2.5% (again, if you believe it). The energy shock has not yet leaked into everything else the way it had by 1978. In the 1970s, a decade of rising prices had taught everyone to expect more of them. That expectation is what made inflation so hard to kill. The same setup is in place now, but it is not yet common knowledge. [Retailers have shielded consumers from diesel price inflation thanks to tariff refunds](https://www.cnbc.com/2026/08/30/trump-tariff-refunds-walmart-home-depot-target.html). That is temporary, and it is coming to an end. The concern is what happens the longer this shock lasts. Whether it stays in diesel and fertilizer or seeps into wages and prices, the longer it goes on, the more likely the public feels it in more places than the pump. And if that happens, history tells us not to be shocked if 5% inflation becomes 20% interest rates in a few years.
...
So the rhyme is in the setup, not the outcome. The boom is there, the squeeze is there, and the inflation setup is there. The starting point looks a lot like 1976, and the public has not yet caught on. Against that, the sector carries far less debt, far less of that debt floats, and the people the shock would land on look nothing like the ones it landed on before. What that adds up to is exactly the thing this data cannot say.
