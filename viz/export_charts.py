...
CHARTS = [
    ...
    ("chart-rural-collapse", "02-rural-collapse", (720, 400)),
    ("chart-sector", "02-fall-by-county-type", (720, 430)),
    ("chart-sectorline", "02-sector-trajectories", (720, 400)),
    ("chart-sectorline", "02-hero-commodity-bust-1680x1080", (1680, 1080),
     {"title": "What a commodity bust did to births",
      "sub": "Fertility rate in rural counties by what their economy ran on in 1975\u201379, with metro for comparison"}),
    ("chart-sectorline", "02-email-hero-1200x772", (600, 386),
     {"title": "What a commodity bust did to births",
      "sub": "Fertility rate in rural counties by what their economy ran on in 1975\u201379, with metro for comparison"}),
